      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-xl text-gray-500">
            Dedicated to delivering excellence in digital solutions
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-base text-gray-500">
                We ensure optimal performance and speed in all our solutions.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">Customizable Solutions</h3>
              <p className="mt-2 text-base text-gray-500">
